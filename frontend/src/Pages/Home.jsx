        ...
        <div className="p-8 bg-gray-100 min-h-screen font-sans text-gray-800">
            ...
            <div className="mt-8">
                ...
                <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="flex flex-col items-start p-6 bg-white rounded-lg shadow-sm h-[130px]"><div className='flex gap-1'><img src={leaf} alt="" className='w-[30px]' /><span className="text-md text-gray-500 mt-1">Total Projects</span></div><span className="text-4xl font-bold">12</span></div>
                    <div className="flex flex-col items-start p-6 bg-white rounded-lg shadow-sm h-[130px]"><div className='flex gap-1'><img src={hand} alt="" className='w-[30px]' /><span className="text-sm text-gray-500 mt-1">Certified Projects</span></div><span className="text-4xl font-bold">5</span></div>
                    <div className="flex flex-col items-start p-6 bg-white rounded-lg shadow-sm h-[130px]"><div className='flex gap-1'><img src={bookMark} alt="" className='w-[26px] bg-white' /><span className="text-sm text-gray-500 mt-1">Credits Issued <span className="text-gray-400">tCO2e</span></span></div><span className="text-4xl font-bold">1,200</span></div>
                    <div className="flex flex-col items-start p-6 bg-white rounded-lg shadow-sm h-[130px]"><div className='flex gap-1'><div className="p-2 bg-blue-100 text-blue-600 rounded-full mb-3"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg></div><span className="text-sm text-gray-500 mt-1">In Review</span></div><span className="text-4xl font-bold">3</span></div>
                </div>
            </div>
            <div className="mt-8">
            ...
            <div className="mt-8">
                ...
                <div className="mt-4 overflow-x-auto bg-white rounded-lg shadow-sm">
                    <table className="min-w-full divide-y divide-gray-200"><thead className="bg-gray-50"><tr><th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Project Name</th><th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Location</th><th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Area</th><th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Actions</th></tr></thead>
                    <tbody className="bg-white divide-y divide-gray-200">
                        {[
                            ["Mangrove Restoration","Alibaug","50 hectares"],["Coastal Wetland Conservation","Sundarbans","120 hectares"],["Seagrass Bed Enhancement","Gulf of Mannar","35 hectares"],["Salt Marsh Rehabilitation","Chilika Lake","80 hectares"],["Estuary Ecosystem Revival","Godavari Delta","60 hectares"]
                        ].map(([name,location,area])=><tr key={name}><td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{name}</td><td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{location}</td><td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{area}</td><td className="px-6 py-4 whitespace-nowrap text-sm"><button className="text-blue-600 hover:text-blue-900 font-medium">View Details</button></td></tr>)}
                    </tbody></table>
                </div>
            </div>
        </div>
