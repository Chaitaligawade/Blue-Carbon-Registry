        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
            ...
            <div className="flex flex-col space-y-4">
              <button className="px-4 py-2 text-blue-600 font-medium rounded-lg border border-blue-600 hover:bg-blue-50 transition duration-200">
                Preview Certificate
              </button>
              <button className="px-4 py-2 bg-blue-600 text-white font-medium rounded-lg shadow hover:bg-blue-700 transition duration-200">
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 flex flex-col">
          ...
          <div className="relative flex-grow bg-gray-100 rounded-lg overflow-hidden flex flex-col items-center justify-center border border-dashed border-gray-300">
            ...
            <div
              ...
              style={{ backgroundImage: "url('/certificate_placeholder.png')" }}
            ></div>
